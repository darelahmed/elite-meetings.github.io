...
export declare enum AgoraAPIName {
    ...
    ADD_INJECT_STREAM_URL = "Client.addInjectStreamUrl",
    REMOVE_INJECT_STREAM_URL = "Client.removeInjectStreamUrl",
    /**
     * 跨直播间连麦
     */
...
export declare function isSupportedMobile(): boolean;
...
export declare const MUTABLE_PARAMS: {
    ...
    /** bitrate adapter type (STANDARD_BITRATE / COMPATIABLE_BITRATE / DEFAULT_BITRATE) */
    ...
    /** DataStream2 相关参数 */
    /**
     * 在纯 RTM2 场景时，rtm2Flag 字段为3，目必填。
     * 在共频道场暴下，join 信令中不填此字段，由SDK 的StreamChannel 动态发送ttm2Flag 的信令包（新增）来控制开关。
     */
    RTM2_FLAG: any;
    /** RTM团队透传字段给ap */
    AP_RTM: boolean;
...
export declare function transformBrowserVersion(result: UAParser_2.IResult): string;
